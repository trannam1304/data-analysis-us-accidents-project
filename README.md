...
Với bộ dữ liệu này, tôi sẽ tập trung phân tích các câu hỏi sau:
 
- Khu vực/tuyến đường nào có mật độ tai nạn cao nhất (top điểm đen)?
- Khung giờ nào trong ngày xảy ra tai nạn nhiều nhất?
- Ngày nào trong tuần có tỷ lệ tai nạn cao nhất?
- Tháng nào trong năm ghi nhận nhiều tai nạn nhất, đặc biệt là mùa mưa bão?
- Mức độ nghiêm trọng (Severity) của tai nạn có thay đổi theo điều kiện thời tiết không?
